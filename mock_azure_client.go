...
func (c *MockAzureClient) SearchWorkItems(assignedTo string) []types.BacklogItem {
	mockData := map[string][]types.BacklogItem{
		"john": {
			{
				ID: 1001, Type: types.Initiative, Title: "Implement new authentication system",
			...
			{
				ID: 1002, Type: types.UserStory, Title: "Add OAuth2 login support",
			...
			{
				ID: 1003, Type: types.Task, Title: "Create login page UI",
			...
			{
				ID: 1004, Type: types.Bug, Title: "Fix login redirect issue",
				AssignedTo: "john", State: "Active", Priority: 1,
		...
		"sarah": {
			{
				ID: 2001, Type: types.Requirement, Title: "API rate limiting requirements",
			...
			{
				ID: 2002, Type: types.UserStory, Title: "Implement rate limiting middleware",
		...
		"mike": {
			{
				ID: 3001, Type: types.Initiative, Title: "Mobile app redesign",
		...
		"emma": {
			{
				ID: 4001, Type: types.UserStory, Title: "Add data export functionality",
